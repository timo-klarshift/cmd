export { EventEmitter } from 'https://deno.land/std@0.73.0/node/events.ts'
export { Buffer } from 'https://deno.land/std@0.73.0/node/buffer.ts'
export * as path from 'https://deno.land/std@0.73.0/path/mod.ts'
import * as _process from 'https://deno.land/std@0.73.0/node/process.ts'
